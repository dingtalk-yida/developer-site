...
<AttrTable
  dataSource={[
    ...
    {
      code: "arrowSize",
      type: "'medium'（正常尺寸）|'large'（大号尺寸）",
      default: "'medium'",
      desc: "用于控制箭头大小。",
    },
    {
      code: "arrowPosition",
      type: " 'inner'（内）|'outer'（外）",
      default: "'inner'",
      desc: "用于控制箭头位置。",
    },
    {
