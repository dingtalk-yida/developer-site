...
![PC端效果演示](https://img.alicdn.com/imgextra/i3/O1CN01twlqRg1NDX66FbHC3_!!6000000001536-2-tps-1343-798.png)

<video width="100%" controls>
  <source
    src="https://cloud.video.taobao.com/play/u/1775663/p/1/d/hd/e/6/t/1/342505494763.mp4?auth_key=YXBwX2tleT04MDAwMDAwMTImYXV0aF9pbmZvPXsidGltZXN0YW1wRW5jcnlwdGVkIjoiYjExN2NiZTdkZDQzN2U0ZjIyM2YyODQ0YTIxOTlkNWMifSZkdXJhdGlvbj0mdGltZXN0YW1wPTE2NDYwNDE3NjE="
    type="video/mp4"
  ></source>
</video>
...
![配置二维码并携带参数](https://img.alicdn.com/imgextra/i3/O1CN01ewK1cx1SBJFu5Z0yi_!!6000000002208-2-tps-1300-766.png)
...
> - 该步骤涉及的 API 详细介绍请参考文档：[宜搭平台接口](https://www.yuque.com/yida/support/aql605#JL8K2)。

** 操作步骤： **

1. 新建远程数据源，命名为「getDatas」>> 开启「自动加载」配置项 >> 修改请求地址为 `/dingtalk/web/此处填写应用的唯一标识/v1/form/searchFormDatas.json。` （操作如下图所示）

![添加远程数据源](https://img.alicdn.com/imgextra/i3/O1CN010yzANb1VXhSmuNFpZ_!!6000000002663-2-tps-1301-767.png)

2. 配置请求参数（操作如下图所示）

![参数变量配置](https://img.alicdn.com/imgextra/i2/O1CN01LSwqoT1Tz3tYbuHYn_!!6000000002452-2-tps-1301-764.png)
...
![配置表格组件](https://img.alicdn.com/imgextra/i3/O1CN01ONlr8A1hGY1HfsL0g_!!6000000004250-2-tps-1301-763.png)
