...
## 效果演示
![image.png](https://img.alicdn.com/imgextra/i4/O1CN01UF16kd1inoP1qQcbD_!!6000000004458-2-tps-762-1676.png)
## 操作步骤
### 步骤一：创建自定义页面
**操作步骤：**
...
![image.png](https://img.alicdn.com/imgextra/i1/O1CN015rpbEW1vZEnomBbfp_!!6000000006186-2-tps-959-531.png)
...
![image.png](https://img.alicdn.com/imgextra/i3/O1CN01GovIZj1owrvimKJEl_!!6000000005290-2-tps-958-495.png)
​


2. 填写名称 >> 选择连接器 >> 填写数据源相关配置项 >> 选择连接器执行动作 >> 填写连接器执行动作参数。（操作如下图所示）

![image.png](https://img.alicdn.com/imgextra/i3/O1CN01Pfdnyx1x0Y2PBiC62_!!6000000006381-2-tps-959-530.png)
:::info
**说明：**
...
![image.png](https://img.alicdn.com/imgextra/i4/O1CN012urAaL1Td4ssb51hf_!!6000000002404-2-tps-959-530.png)
​


4. 将下述代码填写到`onChange()`函数中。（操作如下图所示）

![image.png](https://img.alicdn.com/imgextra/i1/O1CN01BSUtPY1nr5JVLrMRj_!!6000000005142-2-tps-959-530.png)
:::danger
**特别提醒：**
...
![image.png](https://img.alicdn.com/imgextra/i2/O1CN01SnmTf61RFbLfnTDal_!!6000000002082-2-tps-959-530.png)


## 附录
下方给出 fetchOptions 的典型结构，供参考。（如下图所示）
![image.png](https://img.alicdn.com/imgextra/i3/O1CN01qOYcHK1TaKVTJJYO4_!!6000000002398-2-tps-2426-384.png)
