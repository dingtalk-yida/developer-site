...
接口配置如图：
![image.png](https://img.alicdn.com/imgextra/i3/O1CN01B09tXm1vxyBzl9k41_!!6000000006240-2-tps-2754-1246.png)
添加数据源
...
```
### 拖动查询组件，配置输入框
![image.png](https://img.alicdn.com/imgextra/i4/O1CN01gtDMHL1IeUKRow8XB_!!6000000000918-2-tps-2878-1316.png)
自定义页面添加查询组件
### 给查询组件的搜索和重置按钮配置相应动作
:::danger
...
![image.png](https://img.alicdn.com/imgextra/i1/O1CN01LlFBpc1uBajtL004W_!!6000000005999-2-tps-2878-1292.png)
**参考代码如下：**
```javascript
...
![image.png](https://img.alicdn.com/imgextra/i3/O1CN012qwHHo1SPxvgNklQG_!!6000000002240-2-tps-1575-733.png)
**参考代码如下：**
```javascript
...
**--------------------获取宜搭最新信息，欢迎关注我们--------------------**
![宜搭.jpg](https://img.alicdn.com/imgextra/i4/O1CN018I99qN1O8mbby9YZr_!!6000000001661-0-tps-1800-1012.jpg)
