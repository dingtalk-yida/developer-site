...
<video width="100%" controls>
  <source src="https://cloud.video.taobao.com/play/u/1775663/p/1/d/hd/e/6/t/1/332665083092.mp4?auth_key=YXBwX2tleT04MDAwMDAwMTImYXV0aF9pbmZvPXsidGltZXN0YW1wRW5jcnlwdGVkIjoiZmJhZDQ4YWRiZmZjN2FlOGQwNGZmZjY5Mzk4NzJlYWQifSZkdXJhdGlvbj0mdGltZXN0YW1wPTE2NDc1MjA0MTU="></source>
</video>

**单应用展示未读抄送信息效果演示**

<video width="100%" controls>
  <source src="https://cloud.video.taobao.com/play/u/1775663/p/1/d/hd/e/6/t/1/332696863587.mp4?auth_key=YXBwX2tleT04MDAwMDAwMTImYXV0aF9pbmZvPXsidGltZXN0YW1wRW5jcnlwdGVkIjoiZmJhZDQ4YWRiZmZjN2FlOGQwNGZmZjY5Mzk4NzJlYWQifSZkdXJhdGlvbj0mdGltZXN0YW1wPTE2NDc1MjA0MTU="></source>
</video>
...
:::
  ...
  ![](https://img.alicdn.com/imgextra/i2/O1CN01b1E85h1QIWFyu4Iz0_!!6000000001953-2-tps-1046-584.png_.webp)

**（1）设计流程页面**

在页面内放置所需组件和名为「是否查看」的单行文本组件，在属性中设置状态为隐藏，默认值为"否"（操作如下图所示）

![](https://img.alicdn.com/imgextra/i1/O1CN01zphU3J23iPfDMcVQL_!!6000000007289-2-tps-1046-423.png_.webp)

![](https://img.alicdn.com/imgextra/i4/O1CN018n0NJL1C1f3jxDcZn_!!6000000000021-2-tps-1046-442.png_.webp)
...
![](https://img.alicdn.com/imgextra/i4/O1CN012GrLHk1yVypqhCV4a_!!6000000006585-2-tps-1046-587.png_.webp)
...
![](https://img.alicdn.com/imgextra/i1/O1CN01sE2DkZ1kPekGU5VY6_!!6000000004676-2-tps-1919-885.png_.webp)
...
![](https://img.alicdn.com/imgextra/i4/O1CN01pt2OuI1LHzj5nAsI7_!!6000000001275-2-tps-1912-881.png_.webp)

![](https://img.alicdn.com/imgextra/i3/O1CN01eNxuK91QCZ6rkLMaB_!!6000000001940-2-tps-1910-877.png_.webp)
...
![](https://img.alicdn.com/imgextra/i4/O1CN011oTxDK23opD759NUl_!!6000000007303-2-tps-1914-888.png_.webp)

![](https://img.alicdn.com/imgextra/i1/O1CN013thd4u1GL8MX5L2IF_!!6000000000605-2-tps-1911-891.png_.webp)

**（3）自定义页面组件设计**

本页面共添加了四个文本组件，一个链接块组件和一个布局容器组件（操作如下图所示）。
![](https://img.alicdn.com/imgextra/i3/O1CN01kV8qdJ24zeBPshrHj_!!6000000007462-2-tps-1912-891.png_.webp)

**第一个文本组件**：用于记录未查看抄送的数据条数（操作如下图所示）。

![](https://img.alicdn.com/imgextra/i1/O1CN01SqU7Ay1cnSP0iRX7b_!!6000000003645-2-tps-1046-490.png_.webp)

![](https://img.alicdn.com/imgextra/i3/O1CN01qk1ZAY1INXfw9L2WI_!!6000000000881-2-tps-1907-885.png_.webp)
...
链接块组件绑定了循环数据，如果没有设置迭代名变量，默认为 item ，详情参考[循环渲染](/docs/guide/concept/loop)。
![](https://img.alicdn.com/imgextra/i2/O1CN01NpUDT71vUeqKraunE_!!6000000006176-2-tps-1046-749.png_.webp)

![](https://img.alicdn.com/imgextra/i4/O1CN01ug4YiL1sc2NHSvjX4_!!6000000005786-2-tps-1046-487.png_.webp)

**布局容器组件**：作用是调整容器内组件样式，保证页面美观，可以根据需求自行配置样式（操作如下图所示）。

![](https://img.alicdn.com/imgextra/i1/O1CN01Km1saF1jJPjNoawPX_!!6000000004527-2-tps-1918-870.png_.webp)

![](https://img.alicdn.com/imgextra/i4/O1CN017J9Erf29q60Kt0Pf9_!!6000000008118-2-tps-1910-884.png_.webp)
:::danger
第二、第三和第四个文本组件需要在链接块当中获取迭代数据，所以用 `item.xxx` 获取迭代数据。
:::
**第二个文本组件**：用于展示未查看的流程实例标题。

![](https://img.alicdn.com/imgextra/i1/O1CN01fKRKH01zGhEU6SX4W_!!6000000006687-2-tps-1046-486.png_.webp)

**第三、四个文本组件**：在页面展示提交`提交人：${item.originator.name.en_US}`和创建时间`创建时间：${this.utils.formatter('date', item.gmtCreate, 'YYYY-MM-DD HH:mm:ss')}`。

![](https://img.alicdn.com/imgextra/i3/O1CN01XX8hp61XU9d828Yde_!!6000000002926-2-tps-1046-486.png_.webp)

![](https://img.alicdn.com/imgextra/i2/O1CN01ehcOe91hs6V2K5LKE_!!6000000004332-2-tps-1046-485.png_.webp)

**（4）单流程初始化展示未读抄送信息**
首先，在自定义页面绑定初始化函数 didmount，绑定时将代码下述复制到 JS 面板中（操作如下图所示）。

![](https://img.alicdn.com/imgextra/i2/O1CN01uTa0UE1euu4QRJDzT_!!6000000003932-2-tps-1046-492.png_.webp)
...
复制流程页面 1中的「是否查看」组件，保证「是否查看」字段的唯一标识相同。
...
![](https://img.alicdn.com/imgextra/i1/O1CN01n5S4ld1QlpbXHDZT2_!!6000000002017-2-tps-1046-586.png_.webp)

**下拉单选组件绑定 onchange 动作**

![](https://img.alicdn.com/imgextra/i4/O1CN017DNK8i1GCQprINPHh_!!6000000000586-2-tps-1046-485.png_.webp)

![](https://img.alicdn.com/imgextra/i1/O1CN01alo9bZ1qIgPEDuNWa_!!6000000005473-2-tps-1914-881.png_.webp)

![](https://img.alicdn.com/imgextra/i4/O1CN01CwOi891ybTaGCStpQ_!!6000000006597-2-tps-1911-879.png_.webp)
