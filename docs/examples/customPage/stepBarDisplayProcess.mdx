...
![实现效果](https://img.alicdn.com/imgextra/i1/O1CN01Y1Dtsi1ISa2FCNZpc_!!6000000000892-2-tps-1524-714.png)
...
![流程](https://img.alicdn.com/imgextra/i3/O1CN01QJ7UyW1QrKMUfI80C_!!6000000002029-2-tps-1437-807.png)
...
![远程数据源](https://img.alicdn.com/imgextra/i2/O1CN01SVNMTX1IhEi5ZMbOJ_!!6000000000924-2-tps-1439-808.png)
...
![定义变量数据源](https://img.alicdn.com/imgextra/i3/O1CN01e7mN3U1v1LUqyTmhr_!!6000000006112-2-tps-1439-777.png)
![绑定表格](https://img.alicdn.com/imgextra/i3/O1CN01As6zfi20HRUkH6rMa_!!6000000006824-1-tps-1362-736.gif)
实现步骤条与审批数据进行联动。
定义步骤条相关变量数据源（如下图所示）。
![定义](https://img.alicdn.com/imgextra/i2/O1CN015YSkrF1Z5zyVQjRsM_!!6000000003144-2-tps-1359-807.png)
进行变量数据源的绑定（如下图所示）。
...
![绑定](https://img.alicdn.com/imgextra/i3/O1CN01pvYITw1NERtX971V1_!!6000000001538-2-tps-1439-762.png)
将数据处理完成后，赋值给 datas 变量数据源，并更改表格数据字段名称。（如下图所示）
![处理](https://img.alicdn.com/imgextra/i2/O1CN01qRvARf1ibu6lFjkjD_!!6000000004432-2-tps-1439-709.png)
...
![表格列](https://img.alicdn.com/imgextra/i3/O1CN01isnx0o1HTfM3MPsBg_!!6000000000759-2-tps-1439-791.png)
...
![新增](https://img.alicdn.com/imgextra/i1/O1CN01Zc7Y6L1R0wg41rTZi_!!6000000002050-2-tps-1395-807.png)
...
![绑定函数](https://img.alicdn.com/imgextra/i1/O1CN01Zc7Y6L1R0wg41rTZi_!!6000000002050-2-tps-1395-807.png)
然后，在"属性-分页设置"中进行页面"pageSize"的设置中"请求参数-pageSize-参数值"相同，否则会造成展示问题。（如下图所示）
![设置](https://img.alicdn.com/imgextra/i2/O1CN01t1NGgM1zIzDLM8yGZ_!!6000000006692-2-tps-1199-808.png)
