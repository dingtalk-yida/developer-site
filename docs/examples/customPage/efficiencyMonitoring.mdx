...
![流程](https://img.alicdn.com/imgextra/i1/O1CN016VFSFk28CQ4mTvy3g_!!6000000007896-2-tps-1439-806.png)
![流程2](https://img.alicdn.com/imgextra/i2/O1CN01b8DVc31X1l4rNB1qt_!!6000000002864-2-tps-1386-701.png)

### 步骤二：创建数据底表

作用：存储应用内所需查看的流程表单名称和流程表单 formUuid，后续会将表单内的数据在自定义页面获取，放在下拉单选中用作选择查看流程页面审批数据。（如下图所示）
![底表](https://img.alicdn.com/imgextra/i2/O1CN01LCoSPY1Dbfovjxl0u_!!6000000000235-2-tps-1267-806.png)
...
- 「进度指示器组件」：百分比属性绑定变量数据源，并关闭自动渲染，根据变量数据源控制渲染和百分比。
  ![自定义页面](https://img.alicdn.com/imgextra/i3/O1CN01I5P7Qm1kIKPSgJkDS_!!6000000004660-2-tps-1331-563.png)
...
![远程数据源](https://img.alicdn.com/imgextra/i1/O1CN01zvoSn022jUzY0bAy4_!!6000000007156-2-tps-1439-803.png)
...
> ![方法一](https://img.alicdn.com/imgextra/i3/O1CN011BstTw1LGA8lNVh7X_!!6000000001271-2-tps-1438-806.png)
...
> ![方法二](https://img.alicdn.com/imgextra/i1/O1CN01IVqcQI1FxmA8Kr5JJ_!!6000000000554-2-tps-1251-437.png)

** （3） 定义变量数据源 **

由于对返回的数据做了较为复杂的格式处理，所以定义变量数据源 time 和 datas，表格组件绑定 datas 变量数据源。（如下图所示）
![变量数据源](https://img.alicdn.com/imgextra/i1/O1CN01yVaAPp1WtyLMeBpgA_!!6000000002847-2-tps-1439-767.png)
percent 和 condition 分别控制进度指示器组件的百分比和是否渲染属性。（如下图所示）
![数据源](https://img.alicdn.com/imgextra/i2/O1CN01bYCUFN1alVU5NEPAk_!!6000000003370-2-tps-1120-686.png)
** （4） 下拉组件绑定动作触发调用 **
![绑定动作](https://img.alicdn.com/imgextra/i4/O1CN01OXh36H1opzzS9ATxm_!!6000000005275-2-tps-1438-807.png)
![更改数据字段名称](https://img.alicdn.com/imgextra/i4/O1CN01mWZoMU1gHdLSsKJuT_!!6000000004117-2-tps-1392-806.png)
...
![设置操作列](https://img.alicdn.com/imgextra/i3/O1CN01dx4iDl24RksN8YVpE_!!6000000007388-2-tps-1439-791.png)
...
![效果演示](https://img.alicdn.com/imgextra/i4/O1CN01FwO3zm1Dhcy4fSFx5_!!6000000000248-2-tps-1524-706.png)

** （6） 实现分页展示数据 **

![表格组件绑定动作](https://img.alicdn.com/imgextra/i2/O1CN01ikr8Gd1z4mwEQNQMF_!!6000000006661-2-tps-1439-707.png)
...
** (6) 配置初始化时表格提示 **
![效果演示](https://img.alicdn.com/imgextra/i4/O1CN01wAXsgn1hKfaTWa1s9_!!6000000004259-2-tps-1439-434.png)
